...
public class MainPresenter implements MvpPresenter<MainView> {
    ...
    private List<DbQuestionnaire> mList;
    ...
    public MainPresenter(QuestioningService questioningService, DaoSession daoSession) {
    ...
    private void updateView() {
        if (view != null) {
            ...
            if (mList != null) {
                view.questionnaireSuccess(mList);
            } else {
                getQuestionnaires();
            }
    ...
    private void getQuestionnaires() {
        ...
        Log.d(TAG, "-------------getQuestionnaires------------");
        //view.showWait();

        mList = dbQuestionnaireDao
                .queryBuilder()
                .orderDesc(DbQuestionnaireDao.Properties.DateInMillis)
                .list();
        view.questionnaireSuccess(mList);
    }
    ...
    private void getCheck() {
        ...
        Call<ResponseBody> call = service.getCheck(Url + "/GetCheck?Interviewer=" + Interviewer,
    ...
    private Questionnaires prepareQuestionnaires(List<DbQuestionnaire> dbQuestionnaireList) {
        ...
        for (DbQuestionnaire dbQuestionnaire : dbQuestionnaireList) {
            ...
            DbPerson dbPerson = dbQuestionnaire.getPerson();
            if (dbPerson != null){
                questionnaire.setPersonId(dbPerson.getExternalId());
            }
